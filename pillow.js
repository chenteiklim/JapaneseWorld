    ...
    >
        <View style={styles.navBar}>
          ...
          <View style={styles.verticalImage}>
            <View>  
                <Text style={styles.title}>Pillow</Text>
            </View>
            <View style={styles.horizontalImage1}>
              <Image source={require('./assets/yaxinpillow.jpg')} style={styles.item} />     
              <Image source={require('./assets/chifuyu pillow.jpg')} style={styles.item} />     
              <Image source={require('./assets/otaku pillow.jpg')} style={styles.item} />     
              <Image source={require('./assets/zoropillow.jpg')} style={styles.item} />     
            </View>
            <View style={styles.horizontalText}>
              <Text style={styles.smallText1}>Shella Pillow</Text>
              <Text style={styles.smallText2}>Yozora Pillow</Text>
              <Text style={styles.smallText3}>Otaku Pillow</Text>
              <Text style={styles.smallText4}>Zoro Pillow</Text>
            </View>
            ...
            <View style={styles.horizontalImage1}>
              <Image source={require('./assets/yatopillow.jpg')} style={styles.item} />     
              <Image source={require('./assets/yozorapillow.jpg')} style={styles.item} />     
              <Image source={require('./assets/yukibodypillow.png')} style={styles.item} />     
              <Image source={require('./assets/nyupillow.jpg')} style={styles.item} />     
            </View>
            <View style={styles.horizontalText}>
              <Text style={styles.smallText01}>Yato Pillow</Text>
              <Text style={styles.smallText02}>Emma Pillow</Text>
              <Text style={styles.smallText03}>Maria Pillow</Text>
              <Text style={styles.smallText04}>Yuki Pillow</Text>
            </View>
            <View style={styles.horizontalText2}>
