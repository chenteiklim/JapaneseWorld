          ...
          <View style={styles.horizontalContainer}>
            ...
            <View style={styles.verticalAccount2}> 
              <View style={styles.horizontalContainer3}>
                ...
                <Text style={styles.text01}>To Receive</Text>
                <TouchableHighlight
                    underlayColor="#3633E8" // Change the color when the button is pressed
                    onPress={() => navigation.navigate('mypurchase4')}
                    >
                    <Text style={styles.text80}>Completed</Text>
              ...
              <View style={styles.horizontalContainer3}>
                <Text style={styles.text09}>hqopwox_99</Text>
                  ...
                  <Text style={styles.text010}>Completed</Text>
              ...
              <View style={styles.horizontalContainer5}>
                <View>                
                  <Text style={styles.text020}>Arrived Date</Text>
                </View>
                <View>                
                  <Text style={styles.text019}>15 December 2023</Text>
                </View>
              </View>
              ...
              <View style={styles.horizontalContainer5}>
                ...
                <View>                
                  <Text style={styles.text019}>17 December 2023</Text>
                </View>
              </View>
              ...
              <View style={styles.horizontalContainer6}>
                <Image source={require('./assets/lorryicon.png')} style={styles.image2} />     
                <View>                
                  <Text style={styles.text30}>Your order has been successfully delivered</Text>
                </View>
              </View>
