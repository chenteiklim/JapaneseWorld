    ...
    >
     ...
     start={{ x: 0, y: 0 }}
      ...
      style={styles.container2}>
        ...
        <Image source={require('./assets/paymentSuccess.png')} style={styles.addressImg} /> 
        <TouchableHighlight
            style={styles.cancelBtn}
          underlayColor="#3633E8" // Change the color when the button is pressed/
        >
          <Text style={styles.text9}>Print Receipt</Text>
        </TouchableHighlight>  
        <TouchableHighlight
...
const styles = StyleSheet.create({
  ...
  submitBtn:{
    ...
    width: 113,/* Adjust the width of the rhombus */
    height: 40, /* Adjust the height of the rhombus */
    backgroundColor: '#F9E852', /* Set the background color of the rhombus */
  },
  ...
  cancelBtn:{
    ...
    width: 125,/* Adjust the width of the rhombus */
    height: 40, /* Adjust the height of the rhombus */
