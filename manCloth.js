        ...
        <View style={styles.navBar}>
          ...
          <View style={styles.verticalImage}>
            ...
            <View style={styles.horizontalImage1}>
              <Image source={require('./assets/halloweencostume2.jpg')} style={styles.item} />     
              <Image source={require('./assets/zorooutfit.jpg')} style={styles.item} />     
              <Image source={require('./assets/onepunchmanoutfit.jpg')} style={styles.item} />     
              <Image source={require('./assets/luffy outfit.jpg')} style={styles.item} />     
            </View>
            <View style={styles.horizontalText}>
              <Text style={styles.smallText1}>Kakeru Outfit</Text>
              <Text style={styles.smallText2}>Zoro Outfit</Text>
              <Text style={styles.smallText3}>One punch man outfit</Text>
              <Text style={styles.smallText4}>Luffy Outfit</Text>
            </View>
            ...
            <View style={styles.horizontalImage1}>
              <Image source={require('./assets/yatooutfit.jpg')} style={styles.item} />     
              <Image source={require('./assets/demonslayeroutfit.jpg')} style={styles.item} />     
              <Image source={require('./assets/narutooutfit.jpg')} style={styles.item} />     
              <Image source={require('./assets/halloweencostume.jpg')} style={styles.item} />     
            </View>
            <View style={styles.horizontalText}>
              <Text style={styles.smallText01}>Yato Outfit</Text>
              <Text style={styles.smallText02}>Demon Slayer Outfit</Text>
              <Text style={styles.smallText03}>Naruto Outfit</Text>
              <Text style={styles.smallText04}>Halloween Costume</Text>
            </View>
            <View style={styles.horizontalText2}>
