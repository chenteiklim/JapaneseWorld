          ...
          <View style={styles.signupContainer}> 
            ...
            <View>
              <Text style={styles.policy}>     
                By signing up, you agree to Japanese World <Text style={{ color: 'red' }}>Term & Condition</Text> and <Text style={{ color: 'red' }}>Privacy Policy</Text>
              </Text>
            </View>
            <View style={styles.loginContainer}>
              <Text style={styles.loginDescription}>Have an account?</Text>
              <TouchableHighlight
                underlayColor="#3633E8" // Change the color when the button is pressed
