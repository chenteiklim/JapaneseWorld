    ...
    >
        <View style={styles.navBar}>
          ...
          <View style={styles.verticalImage}>
            <View>  
                <Text style={styles.title}>Doll</Text>
            </View>
            <View style={styles.horizontalImage1}>
              <Image source={require('./assets/anyadoll.jpg')} style={styles.item} />     
              <Image source={require('./assets/yozora.jpg')} style={styles.item} />     
              <Image source={require('./assets/mitsukidoll.jpg')} style={styles.item} />     
              <Image source={require('./assets/liliandasuradoll.jpg')} style={styles.item} />     
            </View>
            <View style={styles.horizontalText}>
              <Text style={styles.smallText1}>Anya Doll</Text>
              <Text style={styles.smallText2}>Yozora Doll</Text>
              <Text style={styles.smallText3}>Shiro Doll</Text>
              <Text style={styles.smallText4}>Nyu Doll</Text>
            </View>
            ...
            <View style={styles.horizontalImage1}>
              <Image source={require('./assets/mikudoll.jpg')} style={styles.item} />     
              <Image source={require('./assets/emma doll.jpg')} style={styles.item} />     
              <Image source={require('./assets/mariadoll.jpg')} style={styles.item} />     
              <Image source={require('./assets/chopper.jpg')} style={styles.item} />     
            </View>
            <View style={styles.horizontalText}>
              <Text style={styles.smallText01}>Miku Doll</Text>
              <Text style={styles.smallText02}>Emma Doll</Text>
              <Text style={styles.smallText03}>Maria Doll</Text>
              <Text style={styles.smallText04}>Chopper Doll</Text>
            </View>
            <View style={styles.horizontalText2}>
